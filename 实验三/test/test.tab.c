...
{
       0,     0,     3,     7,    10,    12,    16,    20,    24,    26,
      30,    34,    36,    40,    44,    48,    50,    52,    54,    56
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      19,     0,    -1,    19,    20,    16,    -1,    20,    16,    -1,
      21,    -1,     5,    13,    21,    -1,    21,     6,    22,    -1,
      21,     7,    22,    -1,    22,    -1,    22,     8,    23,    -1,
      22,     9,    23,    -1,    23,    -1,    24,    10,    24,    -1,
      24,    11,    24,    -1,    24,    12,    24,    -1,    24,    -1,
       3,    -1,     4,    -1,     5,    -1,    14,    21,    15,    -1
};

/* YYRLINE[YYN] -- source line where rule number YYN was defined.  */
static const yytype_uint8 yyrline[] =
{
       0,    35,    35,    36,    40,    49,    61,    64,    67,    73,
      76,    79,    85,    88,    91,    94,   100,   102,   104,   107
};
#endif
...
{
  "$end", "error", "$undefined", "INTEGER", "FLOAT", "VARIABLE", "PLUS",
  "MINUS", "TIMES", "DIVIDE", "MOD", "AND", "OR", "EQUALS", "LPAREN",
  "RPAREN", "ENTER", "END", "$accept", "program", "statement", "expr",
  "term", "factor", "primary", YY_NULL
};
#endif
...
{
       0,    16,    17,    18,     0,     0,     0,     4,     8,    11,
      15,     0,    18,     0,     1,     0,     3,     0,     0,     0,
       0,     0,     0,     0,     5,    19,     2,     6,     7,     9,
      10,    12,    13,    14
};
...
{
       3,    -6,    -6,     5,     6,     0,    -3,    -5,    20,    -6,
      11,     6,    -6,     9,    -6,    16,    -6,     6,     6,     6,
       6,     6,     6,     6,    -5,    -6,    -6,    20,    20,    -6,
      -6,    -6,    -6,    -6
};
...
{
      14,    17,    18,     1,     2,     3,     1,     2,     3,     1,
       2,    12,    13,    16,     4,    17,    18,     4,    11,    24,
       4,    21,    22,    23,    25,    31,    32,    33,    19,    20,
      27,    28,    26,    29,    30,    15
};
...
{
       0,     6,     7,     3,     4,     5,     3,     4,     5,     3,
       4,     5,     4,    16,    14,     6,     7,    14,    13,    11,
      14,    10,    11,    12,    15,    21,    22,    23,     8,     9,
      17,    18,    16,    19,    20,     5
};
...
{
       0,     3,     4,     5,    14,    19,    20,    21,    22,    23,
      24,    13,     5,    21,     0,    20,    16,     6,     7,     8,
       9,    10,    11,    12,    21,    15,    16,    22,    22,    23,
      23,    24,    24,    24
};
...
/* Line 1792 of yacc.c  */
#line 40 "test.y"
    { // printf("statement -> expr: %f\n", $1); 
           sprintf(syntax_tree[syntax_tree_index], "statement -> expr: %f\n", (yyvsp[(1) - (1)].floatval)); syntax_tree_index++; 
           printf("Syntax Tree:\n");
...
#line 61 "test.y"
    { (yyval.floatval) = (yyvsp[(1) - (3)].floatval) + (yyvsp[(3) - (3)].floatval); 
        ...
        sprintf(syntax_tree[syntax_tree_index], "|-expr -> expr + term: %f + %f = %f\n", (yyvsp[(1) - (3)].floatval), (yyvsp[(3) - (3)].floatval), (yyval.floatval)); syntax_tree_index++; }
    break;
...
/* Line 1792 of yacc.c  */
#line 85 "test.y"
    { (yyval.floatval) = (int)(yyvsp[(1) - (3)].floatval) % (int)(yyvsp[(3) - (3)].floatval);
        // printf("|---factor -> primary %% primary: %d %% %d = %d\n", (int)$1, (int)$3, (int)$$);
        sprintf(syntax_tree[syntax_tree_index], "|---factor -> primary %% primary: %d %% %d = %d\n", (int)(yyvsp[(1) - (3)].floatval), (int)(yyvsp[(3) - (3)].floatval), (int)(yyval.floatval)); syntax_tree_index++; }
    break;
...
/* Line 1792 of yacc.c  */
#line 100 "test.y"
    { (yyval.floatval) = (yyvsp[(1) - (1)].intval); // printf("|----primary -> INTEGER: %f\n", $1); 
        sprintf(syntax_tree[syntax_tree_index], "|----primary -> INTEGER: %f\n", (yyvsp[(1) - (1)].intval)); syntax_tree_index++; }
    break;

  case 17:
/* Line 1792 of yacc.c  */
#line 102 "test.y"
    { (yyval.floatval) = (yyvsp[(1) - (1)].floatval); // printf("|----primary -> FLOAT: %f\n", $1); 
...
/* Line 1792 of yacc.c  */
#line 104 "test.y"
    { (yyval.floatval) = regs[(yyvsp[(1) - (1)].charval) - 'a']; 
        // printf("|----primary -> VARIABLE: %c = %f\n", $1, $$); 
        sprintf(syntax_tree[syntax_tree_index], "|----primary -> VARIABLE: %c = %f\n", (yyvsp[(1) - (1)].charval), (yyval.floatval)); syntax_tree_index++; }
    break;
